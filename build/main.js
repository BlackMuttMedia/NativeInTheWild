...
/***/ function(module, exports, __webpack_require__) {
	...
	var Griddle = __webpack_require__(2);

	var converter = new Showdown.converter(); 

	var makeMarkdown = function(){
	  var arguments = arguments.length > 0 ? Array.prototype.slice.call(arguments).join('\n\n') : arguments[0];
	  return React.createElement("div", {dangerouslySetInnerHTML: {__html: converter.makeHtml(arguments)}});
	}
	...
	var Slide = React.createClass({displayName: "Slide",
	  render: function(){
	    ...
	    return (React.createElement("div", {className: "slide fadeIn " + this.props.data.className||"", style: wrapperStyle}, 
	        React.createElement("div", {className: "slide-content"}, this.props.data.content)
	      ));
	  }
	});
	...
	/*    return <div className="slide-container"><Griddle results={slideData} resultsPerPage={10} 
	    ...
	    return React.createElement("div", {className: "slide-container"}, React.createElement(Griddle, {results: slideData, resultsPerPage: 1, 
	      ref: "grid", showTableHeading: false, 
	      useCustomRowComponent: true, customRowComponent: Slide, useGriddleStyles: false, showPager: false})); 

	  }
	});

	React.render(React.createElement(SlideShow, null), document.getElementById('main'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	var React = __webpack_require__(1);
	var GridTitle = __webpack_require__(38);
	var GridRowContainer = __webpack_require__(39);
	var ColumnProperties = __webpack_require__(11);
	var RowProperties = __webpack_require__(12);
	var _ = __webpack_require__(37);
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	var React = __webpack_require__(1);
	var GridRow = __webpack_require__(99);
	var ColumnProperties = __webpack_require__(11);
